# workdir-cleanup Specification

## Purpose

TBD - created by archiving change 'workdir-cleanup'. Update Purpose after archive.
...
code:
  ...
  - backend/jirara.db
tests:
  - backend/tests/test_workdir_cleanup.py
-->
